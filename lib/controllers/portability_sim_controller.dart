...
class PortabilitySimSaleController {
  final String apiUrl = "http://preprod-orange.ernst.tn/Main/Api/Sims/CreateSell";
  final String token;

  PortabilitySimSaleController({required this.token});

  Future<Map<String, dynamic>> submitSale(PortabilitySimSaleModel model) async {
    try {
      final headers = {
